...
parser.add_argument('--datapath', type=str, default='/home/niz/Desktop/TRGNASE_Niz/data', help='location of the data corpus')
...
parser.add_argument('--max_width', type=int, default=128, help='maximum number of init channels in search')
